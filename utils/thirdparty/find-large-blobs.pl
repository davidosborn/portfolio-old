...
# Finds large blobs in a Git repository.
# Written by Aristotle Pagaltzis for StackOverflow.
# Licensed under cc-wiki (cc-by-sa).
# http://stackoverflow.com/a/298888
# http://stackoverflow.com/questions/298314
